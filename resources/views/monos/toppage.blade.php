...
　          Monomeetsは使わないけれど捨てられないものを交換しあうサービスです。<br><br>
    ...
    　       <div class="content3">
    　　　　⓵自分が欲しいものがあれば、Wantボタンを押してからリクエストとしてそのモノのページの掲示板に書き込みましょう。<br><br>
    　　　　⓶リクエストされたら、リクエストをしてくれたユーザーのページで交換したいモノを選んでみましょう！<br><br>
    　　　　⓷モノのチャットルームをこまめにチェックしてみましょう！<br><br>
    　　　　⓸また、複数のユーザーからコメントが来ている場合は、一番欲しいモノを持っているユーザーと交換しましょう<br><br>
    　　　　</div>
